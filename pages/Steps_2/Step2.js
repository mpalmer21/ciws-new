const Step2 = (props) => {
  ...
  return (
    <div >
    <label><strong>Dye Pen Test-MPI test: </strong> </label>
    <select
    type="text"
    id="TestMPI"
    name="TestMPI"
    ...
    <label><strong>V'Guides Fitted: </strong> </label>
    <select
    type="text"
    id="VGuides"
    name="VGuides"
  ...
  <label><strong>Components removed: </strong> </label>
    <select
    type="text"
    ...
    <label><strong>Water Plates Supplied: </strong> </label>
    <select
    type="text"
    ...
    <label><strong>Injector Sleeve Fitted: </strong> </label>
    <select
    type="text"
    ...
    <label><strong>Combustion Face: </strong> </label>
    <select
    type="text"
    id="combustionFace"
    name="combustionFace"
